# ✅ CHECKLIST DE INÍCIO - PELADEIROS V2.0 (SUPABASE)
...
|-----------|-----------|------|
| **PLANEJAMENTO-V2-INDEX.md** | Índice completo de documentação | [Abrir](./PLANEJAMENTO-V2-INDEX.md) |
| **SUMARIO-EXECUTIVO-V2.md** | Apresentação stakeholders | [Abrir](./SUMARIO-EXECUTIVO-V2.md) |
| **ARQUITETURA-COMPLETA-SISTEMA-V2.md** | Documentação técnica completa | [Abrir](./ARQUITETURA-COMPLETA-SISTEMA-V2.md) |
| **DECISOES-TECNICAS-V2.md** | Decisões de stack e padrões | [Abrir](./DECISOES-TECNICAS-V2.md) |
| **DATABASE-ARCHITECTURE-SUPABASE-V2.md** | Arquitetura de BD completa | [Abrir](./DATABASE-ARCHITECTURE-SUPABASE-V2.md) |
| **SUPABASE-MIGRATION-SUMMARY.md** | Resumo da migração Supabase | [Abrir](./SUPABASE-MIGRATION-SUMMARY.md) |
...
- [ ] Copiar `service_role` key (NUNCA expor no frontend!)
...
SUPABASE_SERVICE_ROLE_KEY=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9... (NUNCA COMMITAR!)
...
- [ ] `.env.local` adicionado no `.gitignore`
...
- [ ] Link com projeto remoto feito
- [ ] Pasta `supabase/` criada
...
2. [ ] Abrir `supabase/migrations/20260127000001_initial_schema.sql`
3. [ ] Copiar todo conteúdo
4. [ ] Colar no SQL Editor
5. [ ] Clicar em `Run`
6. [ ] Verificar sucesso (mensagem verde)
7. [ ] Repetir para os outros 7 arquivos **NA ORDEM**
...
- [ ] Enums criados
- [ ] Triggers e functions funcionando
...
- [ ] Habilitar `Enable email confirmations` (recomendado)
- [ ] Site URL: `http://localhost:3000` (dev) / `https://resenhapp.com` (prod)
...
**✅ Checklist:**
- [ ] Realtime habilitado para 5 tabelas
- [ ] Broadcast e Presence configurados (padrão)
